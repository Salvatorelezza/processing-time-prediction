...
permit_type = st.selectbox("PERMIT_TYPE", ["PERMIT - NEW CONSTRUCTION", "PERMIT - RENOVATION/ALTERATION", "PERMIT - WRECKING/DEMOLITION"])
review_type = st.selectbox("REVIEW_TYPE", ["DIRECT DEVELOPER SERVICES", "EASY PERMIT", "STANDARD PLAN REVIEW", "DEMOLITION PERMIT"])
reported_cost = st.number_input("REPORTED_COST", min_value=10000, value=2000000)
community_area = st.number_input("Community Areas", min_value=1, value=77)
wd_code = st.number_input("WD_ONEHOTENCODED", min_value=1, value=12)
